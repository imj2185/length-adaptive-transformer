...
function standard_finetune () {
    ...
    #tmux send-keys -t "$1" "CUDA_VISIBLE_DEVICES=$2 python run_glue.py --model_name_or_path $3-base-cased --task_name sst-2 --do_train --do_eval --data_dir glue/SST-2 --max_seq_length 128 --per_device_train_batch_size 32 --per_device_eval_batch_size 32 --learning_rate 2e-5 --num_train_epochs 3.0 --output_dir glue_output/SST-2/standard" Enter
}
